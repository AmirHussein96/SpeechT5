...
if [ $stage -le 1 ] && [ $stop_stage -ge 1 ]; then
    ...
    SAVE_DIR=${expdir}/finetune100_fbank/${JOBID}
    ...
    PT_CHECKPOINT_PATH=$root_dir/exp/pretrain/fbank/checkpoint_best.pt    # the base model is our pretained version for 200k steps.
